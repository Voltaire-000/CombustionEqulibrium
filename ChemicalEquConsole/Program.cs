...
//Func<JToken, bool> filter = r => (string)r["reactant"]?.ToString() ?? "" == "ALC";
...
//JArray filtered = new JArray(jObj["thermo"].Where(filter).DefaultIfEmpty("N/A"));
int mCount = filtered.Count();
